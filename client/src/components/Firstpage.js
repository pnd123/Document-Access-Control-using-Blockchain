    ...
    <div>
      ...
      <div className="animate-section">
        ...
        <p className="animate-para">
          VShare is a decentralized file storage system that uses
          ...
          VShare, data management becomes decentralized and transparent, a
      ...
      <div className="about">
        ...
        <p className="about-text">
          At VShare, we believe that data ownership and privacy are
